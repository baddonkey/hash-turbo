...
_TRANSLATIONS: dict[str, list[str]] = {
    ...
    "de": [
        ...
        "Die Auswahl von Dunkel schaltet die gesamte Oberfläche auf ein dunkles Farbschema.",
        "Der Dunkelmodus ist aktiv. Alle Ansichten passen sich dem gewählten Theme an.",
        "Das Zurückschalten auf Hell stellt die ursprüngliche helle Benutzeroberfläche wieder her.",
    ],
    "fr": [
        ...
        "Sélectionner Sombre bascule toute l'interface vers un schéma de couleurs sombre.",
        "Le mode sombre est actif. Toutes les vues s'adaptent au thème sélectionné.",
        "Revenir au mode Clair restaure l'interface lumineuse d'origine.",
    ],
    "it": [
        ...
        "La selezione di Scuro passa tutta l'interfaccia a una combinazione di colori scura.",
        "La modalità scura è attiva. Tutte le viste si adattano al tema selezionato.",
        "Tornare alla modalità Chiaro ripristina l'interfaccia originale luminosa.",
    ],
    "rm": [
        ...
        "La selecziun da Stgir bascola tut l'interfatscha en in schema da colurs stgir.",
        "Il modus stgir è activ. Tut las vistas s'adatteschan al tema selecziunà.",
        "Returnar al modus Cler restabilescha l'interfatscha originala brillanta.",
    ],
}
