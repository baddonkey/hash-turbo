...
_TRANSLATIONS: dict[str, list[str]] = {
    ...
    "fr": [
        ...
        "Hachage terminé. Passage à l'onglet Vérifier.",
        "Chargez le fichier de hachage et cliquez sur Vérifier pour contrôler l'intégrité.",
    ...
    "it": [
        ...
        "Hashing completato. Passaggio alla scheda Verifica.",
        "Caricare il file hash e cliccare Verifica per verificare l'integrità dei file.",
